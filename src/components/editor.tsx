                        ...
                        <div className="relative size-[62px] flex items-center justify-center group/image">
                            <Hint label="Remove image">
                                <button
                                    ...
                                    className="hidden group-hover/image:flex rounded-fill bg-black/70 hover:bg-black absolute -top-2.5 -right-2.5 rounded-lg text-white size-6 z-[4] border-2 border-white items-center justify-center"
                                >
